				...
				<Card>
					<CardBody>
						...
						<CardText className="text-center">
							...
							<br />
							<hr />
							This project was born out of spite after I called the EDD roughly 400 times in 4 hours without once being able to speak to a human on the phone. While I was eventually able to contact them, I felt that this project still had merit as a proof of conecpt. 
							<br />
							<br />
							...
							<br />
							<br />
							Once you've signed in / signed up, navigate to the profile page. The yellow button at the top will let you start a new collection, or day, of calls. The blue button at the bottom will let you delete your current day if you just can't look at it anymore. Once you're ready to update a column, simply click the plus {"(+)"} sign at the bottom of the colum to incriment that value. Best of luck! You <strong>will</strong> make it, just as I did. Persistance is key.  
							<br />
